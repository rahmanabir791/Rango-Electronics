...
<head>
    <meta charset="utf-8">
    <title>Rango Electronic | Register</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{asset('/')}}front-assets/img/logo/rongo.png" rel="icon">
    ...
    <link href="{{asset('/')}}back-assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="{{asset('/')}}back-assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet">
                ...
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <a href="{{route('front.home')}}" class="">
                            <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Rongo Electronics</h3>
                        </a>
                        <h3>Sign Up</h3>
                    </div>
